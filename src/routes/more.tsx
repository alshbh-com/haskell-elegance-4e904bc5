  ...
  const sections: { title: string; items: Item[] }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <Camera className="size-5" />, title: "بحث بالصورة", desc: "ارفع صورة وهنلاقيلك مثلها", onClick: soon("البحث بالصورة") },
        ...
        { icon: <Layers className="size-5" />, title: "باقات وعروض", desc: "اشتري أكتر ووفّر أكتر", onClick: soon("باقات وعروض") },
        { icon: <ShoppingBag className="size-5" />, title: "الأوتلت", desc: "تشكيلة بأسعار مخفضة", onClick: soon("الأوتلت") },
        ...
        { icon: <Gift className="size-5" />, title: "بطاقات الهدايا", desc: "اهدِ من تحب", onClick: soon("بطاقات الهدايا") },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <Building2 className="size-5" />, title: "استلام من الفرع", desc: "وفّر مصاريف الشحن", onClick: soon("الاستلام من الفرع") },
        { icon: <RotateCcw className="size-5" />, title: "سياسة الاسترجاع", desc: "استرجاع خلال 14 يوم", onClick: () => toast.info("تقدر ترجع المنتج خلال 14 يوم من الاستلام، شرط إنه بحالته الأصلية.") },
